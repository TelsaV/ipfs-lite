...
// as B58-encoded multihashes.
    public static Cid Decode(@NonNull String v) {
        ...
        // TODO String value = Multibase.encode(Multibase.Base.Base32, data);
        return new Cid(data);
    }
...
// varint, and the number of bytes read.
    public static Pair<Long, Integer> FromUvarint(byte[] buf){
        ...
        //                total += read;
        //        }
        //        return new Multihash(t, hash);o Authors and
    ...
    public byte[] Bytes() {
        if( Version() == 0) {
            ...
            /*
            try(InputStream din = new ByteArrayInputStream(multihash)) {
