...
import static net.luminis.tls.TlsConstants.HandshakeType.certificate;
import static net.luminis.tls.TlsConstants.HandshakeType.certificate_request;
import static net.luminis.tls.TlsConstants.HandshakeType.certificate_verify;
import static net.luminis.tls.TlsConstants.HandshakeType.client_hello;
import static net.luminis.tls.TlsConstants.HandshakeType.encrypted_extensions;
import static net.luminis.tls.TlsConstants.HandshakeType.finished;
import static net.luminis.tls.TlsConstants.HandshakeType.new_session_ticket;
import static net.luminis.tls.TlsConstants.HandshakeType.server_hello;
...
public class TlsMessageParser {
    ...
    public HandshakeMessage parseAndProcessHandshakeMessage(ByteBuffer buffer, MessageProcessor messageProcessor, ProtectionKeysType protectedBy) throws TlsProtocolException, IOException {
        ...
        //LogUtils.debug(LogUtils.TAG,  messageProcessor.getClass().getSimpleName() + " message type " + messageType);
