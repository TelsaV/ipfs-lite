...
public abstract class BaseLogger implements Logger {
    ...
    public void receivedPacketInfo(String info) {
        if (logPackets) {
            ...
            log(Strings.repeat(" ", indent) + " -< " + info);
        }
    }
    ...
    protected String formatTime(Instant time) {
        if (useRelativeTime) {
            ...
            return String.format(Locale.ENGLISH, "%.3f", ((double) relativeTime.toNanos()) / 1000000000);  // Use nano's to get correct rounding to millis
        } else {
