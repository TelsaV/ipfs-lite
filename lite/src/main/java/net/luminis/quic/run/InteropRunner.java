...
public class InteropRunner extends KwikCli {
    ...
    private static void testTransfer(List<URL> downloadUrls, QuicClientConnectionImpl.Builder builder) throws IOException, URISyntaxException, TimeoutException {
    ...
    private static void testResumption(List<URL> downloadUrls, QuicClientConnectionImpl.Builder builder) throws IOException, URISyntaxException, TimeoutException {
    ...
    private static void testMultiConnect(List<URL> downloadUrls, QuicClientConnectionImpl.Builder builder) throws URISyntaxException {
        ...
        for (URL download : downloadUrls) {
            try {
                ...
                connection.close();
            } catch (IOException | TimeoutException ioError) {
                logger.error(timeNow() + " Error in client: " + ioError);
            }
        }
    }

    private static void testZeroRtt(List<URL> downloadUrls, QuicClientConnectionImpl.Builder builder) throws IOException, TimeoutException {
        logger.logPackets(true);
        logger.logRecovery(true);
    ...
    private static void testKeyUpdate(List<URL> downloadUrls, QuicClientConnectionImpl.Builder builder) throws IOException, TimeoutException {
        logger.logPackets(true);
