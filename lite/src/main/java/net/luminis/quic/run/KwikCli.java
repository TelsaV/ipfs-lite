...
public class KwikCli {
    ...
    private static final String DEFAULT_LOG_ARGS = "wip";
        ...
        try {
            if (interactiveMode) {
                ...
                if (useZeroRtt && httpRequestPath != null) {
                    ...
                    httpStream = quicConnection.connect(connectionTimeout * 1000, "hq-27", null, Collections.singletonList(earlyData)).get(0);
                } else {
                    if (alpn == null) {
